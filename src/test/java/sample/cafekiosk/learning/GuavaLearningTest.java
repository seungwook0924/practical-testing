...
class GuavaLearningTest {
    ...
    void partitionLearningTest1() {
        ...
        // when
        List<List<Integer>> partition = Lists.partition(integers, 3); // 3개씩 쪼갠다.
    ...
    @DisplayName("멀티맵 기능 확인") // 하나의 키에 여러개 값을 넣으면, 컬렉션 타입인 Map 내에서 값들을 가지고 있다.
    @Test
    ...
    Collection<DynamicTest> multiMapLearningTest2() {
        ...
        return List.of(
            DynamicTest.dynamicTest("1개의 value 삭제", () -> {
                // when
